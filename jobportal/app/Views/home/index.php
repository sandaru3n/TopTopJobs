                ...
                <div class="bg-white dark:bg-gray-800/50 rounded-lg p-6 flex flex-col gap-4 border border-gray-200 dark:border-gray-700/50 hover:shadow-lg hover:border-primary/50 dark:hover:border-primary/50 transition-all duration-300 cursor-pointer" data-job-id="${job.id}" onclick="window.location.href='${jobUrl}'">
                    <div class="flex items-start justify-between">
                        <div class="flex items-center gap-4">
                            <img class="h-12 w-12 rounded-lg object-cover object-center flex-shrink-0 border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-700" alt="${job.company_name} logo" src="${job.company_logo || 'data:image/svg+xml;base64,'}" style="border-radius: 0.75rem; object-fit: cover; object-position: center;" onerror="this.onerror=null; this.src='data:image/svg+xml;base64,'; this.style.borderRadius='0.75rem'; this.style.objectFit='cover'; this.style.objectPosition='center';"/>
                            <div>
